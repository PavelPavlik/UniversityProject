...
public class ReadXlsx {
	...
	public static List<Student> readStudent(String filePath, String sheetName) throws IOException {
	...
	public static List<University> readUniversity(String filePath, String sheetName) throws IOException {
